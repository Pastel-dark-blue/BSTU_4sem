...
namespace Laba6_7.Command
{
    class ApplicationViewModel 
    {
        ...
        private RelayCommand switchLightThemeCommand;
        public RelayCommand SwitchLightThemeCommand
        {
            get
            {
                return switchLightThemeCommand ?? (switchLightThemeCommand = new RelayCommand(obj =>
                {
                    Laba6_7.Themes.SwitchTheme.SwitchLightThemeCommand();
                }
                ));
            }
        }

        private RelayCommand switchDarkThemeCommand;
        public RelayCommand SwitchDarkThemeCommand
        {
            get
            {
                return switchDarkThemeCommand ?? (switchDarkThemeCommand = new RelayCommand(obj =>
                {
                    Laba6_7.Themes.SwitchTheme.SwitchDarkThemeCommand();
                }
                ));
            }
        }
